...
const addAcountBlance = `-- name: AddAcountBlance :one
UPDATE accounts 
...
type AddAcountBlanceParams struct {
	Amount int64 `json:"amount"`
	ID     int64 `json:"id"`
}

func (q *Queries) AddAcountBlance(ctx context.Context, arg AddAcountBlanceParams) (Accounts, error) {
	row := q.db.QueryRow(ctx, addAcountBlance, arg.Amount, arg.ID)
	var i Accounts
	err := row.Scan(
		&i.ID,
		&i.Owner,
